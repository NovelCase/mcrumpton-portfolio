...
export default class LanternView extends React.Component {
  ...
  componentDidMount() {
    ...
    const lanterns = this.createSprite(
      ...
      (PixiApp.app.renderer.view.height / 2) * 2.77,
      /* 2.8 */ lanternsTexture,
      'lantern'
    );

    const book = this.createSprite(
      (PixiApp.app.renderer.view.width / 4) * 0.63 /* 0.65 */,
      (PixiApp.app.renderer.view.height / 2) * 2.8 /* 2.9 */,
      bookTexture,
      'book',
      true
    );
    ...
    const teapot = this.createSprite(
      ...
      (PixiApp.app.renderer.view.height / 2) * 3.22 /* 3.27 */,
      teaTexture,
      'teapot',
      true
    );
    ...
    const nintendoSwitch = this.createSprite(
      ...
      (PixiApp.app.renderer.view.height / 2) * 3.2 /* 3.28 */,
      nintendoTexture,
      'nintendoSwitch',
      true
    );
    ...
    const souls = this.createSprite(
      ...
      (PixiApp.app.renderer.view.height / 2) * 3.5 /* 3.6 */,
      soulTexture,
      'souls'
    );
